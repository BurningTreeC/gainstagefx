...
| (proposed `pedal_dallas_rangemaster`) | Treble Boost | **Dallas Rangemaster**, OC44 germanium PNP | none yet | RESEARCHED 2026-09-25, cleared as the stock unit | Values agreed across sources (ElectroSmash analysis with its own 38 dB / 2.6 kHz figures); no factory drawing. Iommi's modification is undocumented. Log: `docs/models/treble_boost.md` | none | pedal slot | *Paranoia '70* (with the Brum 100) | new `pedal` id | Treble Boost |
...
| (proposed `amp_sunn_model_t`) | Oregon T | **Sunn Model T**, drawing D-1029 rev A, 9/25/1973 (4 x 6550) | none yet | RESEARCHED 2026-09-25, cleared | Sunn's own drawing with a no-signal and 150 W voltage chart. Needs a 6550 fit and an ultralinear power stage. Log: `docs/models/oregon_t.md` | new (6550, ultralinear) | physical cabinets | blocks *Unknown Garden '94* | new `circuit` and `power_amp` ids | Oregon T |
| (proposed `amp_marshall_1992`) | Brit Plexi Bass | Marshall **1992 Super Bass**, Unicord 70-13-11 July 1970 | none yet | RESEARCHED 2026-09-25, cleared (stock amplifier) | Same Unicord set as the Brit Plexi; differences tabulated (shared V1 cathode, .022 couplings, no bright network, 250 pF / 56 k stack). The presets want modified units whose modifications are undocumented. Log: `docs/models/brit_plexi_bass.md` | likely `PLEXI_EL34` | physical cabinets | *Spiral '96*, *Californicated '99* (with a JTM45) | new `circuit` id | Brit Plexi Bass |
| (proposed `amp_laney_supergroup`) | Brum 100 | **Laney Supergroup 100 Mk I**, 1969 build | none yet | RESEARCHED 2026-09-25, cleared on a **traced** drawing (vddj, 2008) | No factory sheet retrieved; the trace agrees with independent accounts of split 1.5 k / 25 uF V1 cathodes and a Super-Bass-like stack. Supply voltages missing. Log: `docs/models/brum_100.md` | new (its own EL34 stage, 3.3 k presence) | physical cabinets | *Paranoia '70* (with the treble booster) | new `circuit` and `power_amp` ids | Brum 100 |
...
14. **Versioned corrections** of inherited approximations: Mark IIC+ PI values (the 5150
    tone stack and DR103 presence were done 2026-09-25). Twin PI/supply and Mark recovery/master/graphic corrections are already present. Each needs its
