...
fn print(name: &str, circuit: gainstagefx::dsp::netlist::Circuit) {
    ...
    match sim.nonlinear_reduction() {
        Some((boundary, internal)) => println!(
            ...
            sim.unknowns(), boundary, internal
        ),
...
fn main() {
    print("HM-2", heavy_metal::build(10_000.0, 470_000.0).expect("HM-2 builds"));
    print("MT-2", metal_zone::build(10_000.0, 470_000.0).expect("MT-2 builds"));
}
