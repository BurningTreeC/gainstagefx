...
fn main() {
    println!("{:<14}{:>4}{:>10}{:>10}{:>12}{:>10}", "circuit", "OS", "load", "passes", "drive V", "peak out");
    for gain in [voice::Gain::Crunch, voice::Gain::Screamer, voice::Gain::Muff,
                 voice::Gain::Boogie, voice::Gain::Peavey] {
      for os in [1usize, 2, 4] {
        ...
        c.apply(&Settings { gain, drive: 0.8, tone: ToneSection::Off,
                            cabinet: Cabinet::Off, oversampling: os, ..Settings::default() });
        c.settle();
        ...
        println!("{:<14}{os:>3}x{load:>9.1}%{:>10.2}{:>11.4}V{:>10.2}",
