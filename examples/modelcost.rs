...
use gainstagefx::voice::{
    self, Cabinet, Chain, Settings, Tone as ToneSection, CALIBRATION, NOMINAL_DBFS,
};
const RATE: f64 = 48_000.0;
fn main() {
    println!(
        "{:<14}{:>4}{:>10}{:>10}{:>12}{:>10}",
        "circuit", "OS", "load", "passes", "drive V", "peak out"
    );
    for gain in [
        voice::Gain::Crunch,
        voice::Gain::Screamer,
        ...
        for os in [1usize, 2, 4] {
            ...
            println!(
                "{:<14}{os:>3}x{load:>9.1}%{:>10.2}{:>11.4}V{:>10.2}",
                gain.name(),
                c.passes_per_sample(),
                CALIBRATION[i].drive_volts,
                peak
            );
